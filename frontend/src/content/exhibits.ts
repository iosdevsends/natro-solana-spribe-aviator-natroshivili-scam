...
export const exhibits: ExhibitDTO[] = [
  ...
  { id: 4, slug: 'david-linkedin', exhibitNumber: 'Exhibit 4', fileNumber: 4, displayOrder: 4, title: 'David Natroshvili — Spribe LinkedIn', mediaType: 'image', legacySrc: '/exhibits/ex04-david-linkedin-spribe-interview.png', source: 'LinkedIn / SPRIBE official page (31,892 followers)', highlighted: false },
